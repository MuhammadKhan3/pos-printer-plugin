...
const dayclose_printer_template_1 = require('../printer_templates/dayclose/dayclose_printer_template_1');
const dayclose_printer_template_2 = require('../printer_templates/dayclose/dayclose_printer_template_2');


module.exports = {
    dayclose_printers: function(req) {
        printer_start(req);
    }
};
...
function printer_start(print_data) {
    ...
    let daycloseTemplate = printer_meta?.dayclose_template;

    printers.push({
        printer_device: printer_device,
        printer_conn: printer_conn,
        template:daycloseTemplate,
...
setInterval(function() {
    ...
    if ((printer_flag) && (printers.length > 0)) {
        ...
        current_device?.open(function() {
            ...
            dayclose_printer_template_2.dayclose_printer_template_2(current_conn, current_print_data, {
                date: current_date,
                time: current_time
            });
