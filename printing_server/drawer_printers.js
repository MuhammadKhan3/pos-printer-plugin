...
const drawer_printer_template_1 = require('../printer_templates/drawer/drawer_printer_template_1');
const drawer_reconciliation_report = require('../printer_templates/drawer/drawer_reconciliation_report');


module.exports = {
    drawer_printers: function(req) {
        printer_start(req);
    }
};
...
setInterval(function() {
    ...
    if ((printer_flag) && (printers.length > 0)) {
        ...
        current_device.open(function() {
            ...
            if (current_print_data.receipt == "cashDrawerManagementReport") {

                drawer_reconciliation_report.drawer_reconciliation_report(current_conn, current_print_data, {
                date: current_date,
                time: current_time
            });
            ...
            drawer_printer_template_1.drawer_printer_template_1(current_conn, current_print_data, {
                date: current_date,
                time: current_time
            });
        }
