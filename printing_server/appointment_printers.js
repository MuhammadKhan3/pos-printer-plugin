...
const appointment_printer_template_1 = require('../printer_templates/counter/appointment_printer_template_1');


module.exports = {
    appointment_printers: function(req) {
        printer_start(req);
    }
};
...
function printer_start(print_data) {
    ...
    if (receipt_type == 'appointment_receipt') {
...
setInterval(function() {
    ...
    if ((printer_flag) && (printers.length > 0)) {
        ...
        current_device.open(function() {
            ...
            appointment_printer_template_1.appointment_printer_template_1(current_conn, current_print_data, {
                date: current_date,
                time: current_time
            });
