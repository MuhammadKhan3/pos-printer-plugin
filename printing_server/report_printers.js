...
const rider_report_printer_template_1 = require('../printer_templates/report/rider_report_printer_template_1');


module.exports = {
    report_printers: function(req) {
        printer_start(req);
    }
};
...
setInterval(function() {
    ...
    if ((printer_flag) && (printers.length > 0)) {
        ...
        current_device.open(function() {
            ...
            rider_report_printer_template_1.rider_report_printer_template_1(current_conn, current_print_data, {
                date: current_date,
                time: current_time
            });
