...
const giftcard_printer_template_1 = require('../printer_templates/giftcard/giftcards_printer_template_1');


module.exports = {
    giftcard_printers: function(req) {
        printer_start(req);
    }
};
...
setInterval(function() {
    ...
    if ((printer_flag) && (printers.length > 0)) {
        ...
        current_device.open(function() {
            ...
            giftcard_printer_template_1.giftcard_printer_template_1(current_conn, current_print_data, {
                date: current_date,
                time: current_time
            });
